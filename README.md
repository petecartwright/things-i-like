...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create things-i-like-947b
  fly create things-i-like-947b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app things-i-like-947b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app things-i-like-947b-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'things-i-like-947b-staging' does not match app name in config file 'things-i-like-947b'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name things-i-like-947b-db
  fly postgres attach --postgres-app things-i-like-947b-db --app things-i-like-947b

  fly postgres create --name things-i-like-947b-staging-db
  fly postgres attach --postgres-app things-i-like-947b-staging-db --app things-i-like-947b-staging
  ```
